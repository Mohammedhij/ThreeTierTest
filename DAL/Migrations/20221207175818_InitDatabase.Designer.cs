...
namespace DAL.Migrations
{
    ...
    [Migration("20221207175818_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Applicants", b =>
                {
                    ...
                    b.Property<DateTime>("applicant_creationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 7, 17, 58, 18, 575, DateTimeKind.Utc).AddTicks(2217))
            ...
            modelBuilder.Entity("DAL.Entities.Application", b =>
                {
                    ...
                    b.Property<DateTime>("Application_CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 7, 17, 58, 18, 591, DateTimeKind.Utc).AddTicks(7636))
            ...
            modelBuilder.Entity("DAL.Entities.ApplicationStatus", b =>
                {
                    ...
                    b.Property<DateTime>("ApplicationStatus_CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 7, 17, 58, 18, 589, DateTimeKind.Utc).AddTicks(2843))
            ...
            modelBuilder.Entity("DAL.Entities.Grade", b =>
                {
                    ...
                    b.Property<DateTime>("Grade_CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 7, 17, 58, 18, 590, DateTimeKind.Utc).AddTicks(9699))
            ...
            modelBuilder.Entity("DAL.Entities.Application", b =>
                {
                    b.HasOne("DAL.Entities.Applicants", "Applicants")
